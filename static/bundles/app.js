...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "/Users/kevindenny/Documents/django-vue-boilerplate/assets/js/components/Home.vue"
  if (!module.hot.data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Home_vue__ = __webpack_require__(5);
...
const app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#app',
    components: {
        home: __WEBPACK_IMPORTED_MODULE_2__components_Home_vue___default.a
    }
});
...
var _vueGoogleAutocomplete = __webpack_require__(28);

var _vueGoogleAutocomplete2 = _interopRequireDefault(_vueGoogleAutocomplete);

var _vueSelect = __webpack_require__(29);
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      options: {
        category: ['Subscriptions', 'Entitlements', 'Digital Conversions', 'Adblocking'],
        animation: ['Takeover', 'Dot', 'Arc'],
        side: ['right', 'left']
      }
    };
  },
  ...
  methods: {
    ...
    selectOrigin: function selectOrigin(addressData, placeResultData, id) {
      var cloc = this.getAddressData(addressData, placeResultData, id);
      this.form.origin = cloc;
      this.arcText = null;
      console.log(this.$refs["arcs"]);
      this.$refs["arcs"].$el.value = '';
    },
    addConnection: function addConnection(addressData, placeResultData, id) {
      var cloc = this.getAddressData(addressData, placeResultData, id);
    ...
    selectPub: function selectPub(p, d) {
    ...
    submitForm: function submitForm() {
      ...
      var local_url = 'http://127.0.0.1:8000/events/';
      this.$http.post(local_url, this.form).then(function (response) {
...
//   <div>
//     <div class="container">
//       <div class="card" v-for="ev in events">
...
//           {{ ev.text }}
//           <div class="subtitle">
//             <span class="arc-city">{{ ev.origin.name }}, {{ ev.origin.region }}</span>
//             <span v-if="ev.arc_connections.length > 0">-></span>
//             <span v-for="arc in ev.arc_connections" class="arc-city">{{ arc.name }}, {{ arc.region }} </span>
//           </div>
//         </div>
//       </div>
//     </div>
...
var _EntryForm = __webpack_require__(26);
...
exports.default = {
  name: 'Home',
  components: {
    entry_form: _EntryForm2.default,
    event_list: _EventList2.default
  },
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    ...
    this.$http.get(this.urls.events).then(function (response) {
      var data = response.body;
      _this.events = data.events;
    });
    this.$http.get(this.urls.publishers).then(function (response) {
      var data = response.body;
  ...
  mounted: function mounted() {
    ...
    this.autocomplete.addListener('place_changed', function () {
      ...
      if (!place.geometry) {
        ...
        _this.$emit('no-results-found', place, _this.id);
        return;
      }
...
// module
exports.push([module.i, "\n  h1[_v-116113cf], h2[_v-116113cf] {\n    font-weight: normal;\n  }\n  ul[_v-116113cf] {\n    list-style-type: none;\n    padding: 0;\n  }\n  li[_v-116113cf] {\n    display: inline-block;\n    margin: 0 10px;\n  }\n  a[_v-116113cf] {\n    color: #42b983;\n  }\n\n  .arc-connection[_v-116113cf] {\n    width: 33%;\n    float: left;\n    margin: 20px 0px;\n  }\n\n  .form-check[_v-116113cf] {\n    float: left;\n    display: block;\n    width: 100%\n  }\n\n  .container[_v-116113cf] {\n    border: 1px solid black;\n    padding: 10px 40px;\n  }\n", ""]);
...
// module
exports.push([module.i, "\n  .subtitle[_v-1304fcd1] {\n    padding-top: 10px;\n  }\n  .card[_v-1304fcd1] {\n    margin: 30px 0px;\n  }\n\n  .arc-city[_v-1304fcd1] {\n    border: 1px solid black;\n    padding: 5px 10px;\n    margin-right: 10px;\n  }\n", ""]);
...
// module
exports.push([module.i, "\n    .btn[_v-cf560914] {\n        margin-top: 30px;\n        display: inline-block;\n    }\n    .globekit-canvas-container[_v-cf560914] {\n        display: inline-block;\n        width: 100%;\n        height: 1100px;\n        border: 1px solid black;\n    }\n", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-116113cf&file=EntryForm.vue&scoped=true!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./EntryForm.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-116113cf&file=EntryForm.vue&scoped=true!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./EntryForm.vue");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1304fcd1&file=EventList.vue&scoped=true!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./EventList.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1304fcd1&file=EventList.vue&scoped=true!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./EventList.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-cf560914&file=Home.vue&scoped=true!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Home.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-cf560914&file=Home.vue&scoped=true!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Home.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = "\n  <div class=\"container\" style=\"width: 100%\" v-if=\"publishers\" _v-116113cf=\"\">\n    <form _v-116113cf=\"\">\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"exampleSelect1\" _v-116113cf=\"\">Select Publisher</label>\n        <v_select id=\"exampleSelect1\" v-if=\"publishers.length > 0\" v-model=\"form.publisher\" label=\"name\" :options=\"publishers\" _v-116113cf=\"\"></v_select>\n        <v_select id=\"exampleSelect1\" v-if=\"publishers.length == 0\" label=\"name\" :options=\"['Publishers loading']\" _v-116113cf=\"\"></v_select>\n      </div>\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"city\" _v-116113cf=\"\">Enter Origin</label>\n        <vue-google-autocomplete id=\"city\" classname=\"form-control\" placeholder=\"Start typing\" :types=\"'(cities)'\" v-on:placechanged=\"selectOrigin\" _v-116113cf=\"\">\n        </vue-google-autocomplete>\n      </div>\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"city2\" style=\"width: 100%; display: block;\" _v-116113cf=\"\">Arc Connections</label>\n        <div class=\"card arc-connection\" v-if=\"form.arc_connections.length > 0\" v-for=\"c in form.arc_connections\" _v-116113cf=\"\">\n          <div class=\"card-body\" _v-116113cf=\"\">\n            {{ c.name }}\n          </div>\n        </div>\n        <vue-google-autocomplete id=\"city2\" ref=\"arcs\" classname=\"form-control\" placeholder=\"Start typing\" :types=\"'(cities)'\" v-on:placechanged=\"addConnection\" _v-116113cf=\"\">\n        </vue-google-autocomplete>\n      </div>\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"categorySelect\" _v-116113cf=\"\">Select Category</label>\n        <v_select id=\"categorySelect\" v-model=\"form.category\" :options=\"options.category\" _v-116113cf=\"\"></v_select>\n      </div>\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"exampleTextarea\" _v-116113cf=\"\">Enter event text</label>\n        <textarea class=\"form-control\" id=\"exampleTextarea\" rows=\"3\" placeholder=\"Start typing\" v-model=\"form.text\" _v-116113cf=\"\"></textarea>\n      </div>\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"animationSelect\" _v-116113cf=\"\">Select Animation</label>\n        <v_select id=\"animationSelect\" v-model=\"form.animation\" :options=\"options.animation\" _v-116113cf=\"\"></v_select>\n      </div>\n      <div class=\"form-group\" _v-116113cf=\"\">\n        <label for=\"sideSelect\" style=\"\" _v-116113cf=\"\">Select Display Side</label>\n        <div id=\"sideSelect\" _v-116113cf=\"\">\n          <div class=\"form-check\" style=\"float: left;\" _v-116113cf=\"\">\n            <input class=\"form-check-input\" type=\"radio\" name=\"exampleRadios\" id=\"exampleRadios1\" value=\"right\" v-model=\"form.side\" checked=\"\" _v-116113cf=\"\">\n            <label class=\"form-check-label\" for=\"exampleRadios1\" _v-116113cf=\"\">\n              Right\n            </label>\n          </div>\n          <div class=\"form-check\" style=\"float: left;\" _v-116113cf=\"\">\n            <input class=\"form-check-input\" type=\"radio\" name=\"exampleRadios\" id=\"exampleRadios2\" value=\"left\" v-model=\"form.side\" _v-116113cf=\"\">\n            <label class=\"form-check-label\" for=\"exampleRadios2\" _v-116113cf=\"\">\n              Left\n            </label>\n          </div>\n        </div>\n        <!--<v-select id=\"sideSelect\" v-model=\"form.side\" :options=\"options.side\"></v-select>-->\n      </div>\n      <button class=\"btn btn-primary\" v-on:click=\"submitForm\" _v-116113cf=\"\">Submit</button>\n    </form>\n  </div>\n\n";

/***/ }),
/* 24 */
/***/ (function(module, exports) {

module.exports = "\n  <div _v-1304fcd1=\"\">\n    <div class=\"container\" _v-1304fcd1=\"\">\n      <div class=\"card\" v-for=\"ev in events\" _v-1304fcd1=\"\">\n        <div class=\"card-header\" _v-1304fcd1=\"\">\n          {{ ev.publisher.name }}\n        </div>\n        <div class=\"card-body\" _v-1304fcd1=\"\">\n          {{ ev.text }}\n          <div class=\"subtitle\" _v-1304fcd1=\"\">\n            <span class=\"arc-city\" _v-1304fcd1=\"\">{{ ev.origin.name }}, {{ ev.origin.region }}</span>\n            <span v-if=\"ev.arc_connections.length > 0\" _v-1304fcd1=\"\">-&gt;</span>\n            <span v-for=\"arc in ev.arc_connections\" class=\"arc-city\" _v-1304fcd1=\"\">{{ arc.name }}, {{ arc.region }} </span>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n";

/***/ }),
/* 25 */
/***/ (function(module, exports) {

module.exports = "\n    <div _v-cf560914=\"\">\n        <h1 style=\"float: left; padding-left: 30%;\" _v-cf560914=\"\">Globekit Data Entry CMS</h1>\n        <div class=\"row\" style=\"width: 100%\" _v-cf560914=\"\">\n            <div class=\"col-6\" v-if=\"events &amp;&amp; !showGlobe\" _v-cf560914=\"\">\n                <h3 _v-cf560914=\"\">Events List</h3>\n                <event_list :events=\"events\" _v-cf560914=\"\"></event_list>\n            </div>\n            <div class=\"col-3\" v-if=\"events &amp;&amp; showGlobe\" _v-cf560914=\"\">\n                <h3 _v-cf560914=\"\">Events List</h3>\n                <event_list :events=\"events\" _v-cf560914=\"\"></event_list>\n            </div>\n            <div class=\"col-6\" v-if=\"!events\" _v-cf560914=\"\">\n                Events loading...\n            </div>\n            <div class=\"col-6\" v-if=\"!showGlobe\" _v-cf560914=\"\">\n                <h3 _v-cf560914=\"\">Create new event</h3>\n                <entry_form :publishers=\"publishers\" v-on:submit=\"submit\" _v-cf560914=\"\"></entry_form>\n                <button class=\"btn btn-primary\" v-on:click=\"loadGlobe\" _v-cf560914=\"\">Show Globe</button>\n            </div>\n            <div class=\"col-9\" v-if=\"showGlobe\" _v-cf560914=\"\">\n                <div class=\"globekit-canvas-container\" _v-cf560914=\"\">\n                    <canvas id=\"globekit-canvas\" width=\"1024\" height=\"1024\" _v-cf560914=\"\"></canvas>\n                </div>\n                <div id=\"globe-key\" _v-cf560914=\"\">\n                    <ul id=\"globe-key-list\" _v-cf560914=\"\"></ul>\n                </div>\n                <button class=\"btn btn-primary\" v-on:click=\"showForm\" _v-cf560914=\"\">Show Form</button>\n            </div>\n        </div>\n    </div>\n\n";
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/kevindenny/Documents/django-vue-boilerplate/assets/js/components/EntryForm.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/kevindenny/Documents/django-vue-boilerplate/assets/js/components/EventList.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/kevindenny/Documents/django-vue-boilerplate/node_modules/vue-google-autocomplete/src/VueGoogleAutocomplete.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
